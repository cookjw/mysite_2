...
def create_poll(question, days):
    """
    Creates a poll wit the given 'question' published the given number
...
class PollViewTests(TestCase):
    ...
    def test_index_view_with_two_past_polls(self):
        """
        The polls index page may dsiplay mutliple polls.
        """
...
class PollMethodTests(TestCase):
    ...
    def test_was_published_reccently_with_recent_poll(self):
         """
